...
var testPods = []v1.Pod{
	v1.Pod{
		...
		Spec: v1.PodSpec{NodeName: "caas_master", Containers: []v1.Container{{Name: "cont_shared", Resources: v1.ResourceRequirements{
			Requests: v1.ResourceList{"auros.k8s.io/shared_caas": quantity100m}}}}},
	...
	v1.Pod{
		...
		Spec: v1.PodSpec{NodeName: "caas_master", Containers: []v1.Container{{Name: "cont_exc", Resources: v1.ResourceRequirements{
			Requests: v1.ResourceList{"auros.k8s.io/exclusive_caas": quantity2}}}}},
	...
	v1.Pod{
		...
		Spec: v1.PodSpec{NodeName: "caas_master", Containers: []v1.Container{
			{Name: "cont_excl1", Resources: v1.ResourceRequirements{Requests: v1.ResourceList{"auros.k8s.io/exclusive_caas": quantity2}}},
			{Name: "cont_excl2", Resources: v1.ResourceRequirements{Requests: v1.ResourceList{"auros.k8s.io/exclusive_caas": quantity3}}}}},
	...
	v1.Pod{
		...
		Spec: v1.PodSpec{NodeName: "caas_master", Containers: []v1.Container{
			{Name: "cont_exclusive", Resources: v1.ResourceRequirements{Requests: v1.ResourceList{"auros.k8s.io/exclusive_caas": quantity1}}},
			{Name: "cont_shared", Resources: v1.ResourceRequirements{Requests: v1.ResourceList{"auros.k8s.io/shared_caas": quantity100m}}}}},
		Status: v1.PodStatus{Phase: "Running", ContainerStatuses: []v1.ContainerStatus{
	...
	v1.Pod{
		...
		Spec: v1.PodSpec{NodeName: "caas_master", Containers: []v1.Container{
			{Name: "cont_exclusive", Resources: v1.ResourceRequirements{Requests: v1.ResourceList{"auros.k8s.io/exclusive_caas": quantity1}}},
			{Name: "cont_shared", Resources: v1.ResourceRequirements{Requests: v1.ResourceList{"auros.k8s.io/shared_caas": quantity100m}}},
			{Name: "cont_default", Resources: v1.ResourceRequirements{Requests: v1.ResourceList{"auros.k8s.io/default_caas": quantity1}}}}},
		Status: v1.PodStatus{Phase: "Running", ContainerStatuses: []v1.ContainerStatus{
	...
	v1.Pod{
		...
		Spec: v1.PodSpec{NodeName: "caas_master", Containers: []v1.Container{{Name: "cont_default_explicit", Resources: v1.ResourceRequirements{
			Requests: v1.ResourceList{"auros.k8s.io/default": quantity1}}}}},
	...
	v1.Pod{
		ObjectMeta: metav1.ObjectMeta{Name: "pod_exc_pin_2_proc_2_cont", UID: "pod0008",
			Annotations: map[string]string{"auros.k8s.io/cpus": "[" +
		...
		Spec: v1.PodSpec{NodeName: "caas_master", Containers: []v1.Container{
			{Name: "cont_exc_pin1", Resources: v1.ResourceRequirements{Requests: v1.ResourceList{"auros.k8s.io/exclusive_caas": quantity2}}},
			{Name: "cont_exc_pin2", Resources: v1.ResourceRequirements{Requests: v1.ResourceList{"auros.k8s.io/exclusive_caas": quantity2}}}}},
		Status: v1.PodStatus{Phase: "Running", ContainerStatuses: []v1.ContainerStatus{
	...
	v1.Pod{
		ObjectMeta: metav1.ObjectMeta{Name: "pod_exc_pin_2_proc_1_cont", UID: "pod0009",
			Annotations: map[string]string{"auros.k8s.io/cpus": "[{\"container\": \"cont_exc_pin\", \"processes\": [" +
	...
	v1.Pod{
		ObjectMeta: metav1.ObjectMeta{Name: "pod_pin_2_proc_exc_shared", UID: "pod0010",
			Annotations: map[string]string{"auros.k8s.io/cpus": "[{\"container\": \"cont_pin_exc_shared\", \"processes\": [" +
		...
		Spec: v1.PodSpec{NodeName: "caas_master", Containers: []v1.Container{{Name: "cont_pin_exc_shared", Resources: v1.ResourceRequirements{
			Requests: v1.ResourceList{"auros.k8s.io/exclusive_caas": quantity1, "auros.k8s.io/shared_caas": quantity100m}}}}},
	...
	v1.Pod{
		...
		Spec: v1.PodSpec{NodeName: "caas_master", Containers: []v1.Container{{Name: "pod_empty_cont_statuses", Resources: v1.ResourceRequirements{
			Requests: v1.ResourceList{"auros.k8s.io/exclusive_caas": quantity3}}}}},
		Status: v1.PodStatus{Phase: "Running", ContainerStatuses: []v1.ContainerStatus{}}},
	v1.Pod{
	...
	v1.Pod{
		...
		Spec: v1.PodSpec{NodeName: "caas_master", Containers: []v1.Container{{Name: "pod_cont_name_and_id_empty", Resources: v1.ResourceRequirements{
			Requests: v1.ResourceList{"auros.k8s.io/exclusive_caas": quantity1}}}}},
